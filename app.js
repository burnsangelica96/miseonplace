...
const ROLE_PERMISSIONS = {
  owner: ['dashboard','kitchen','bar','misc','recipes','food_cost','menu_pricing',
          'sop_foh','sop_boh','daily_sales','order_history','financials','labor','hr',
          'team_logs','checklists','user_approvals'],
  manager: ['dashboard','kitchen','bar','misc','recipes','food_cost','menu_pricing',
            'sop_foh','sop_boh','daily_sales','order_history','labor',
            'team_logs','checklists'],
  kitchen: ['dashboard','kitchen','recipes','food_cost','sop_boh',
            'order_history','team_logs','checklists'],
  bar: ['dashboard','bar','food_cost','sop_foh',
        'order_history','team_logs','checklists'],
};
